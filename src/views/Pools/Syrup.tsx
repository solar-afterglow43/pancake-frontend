      ...
      <Hero>
        <div>
          <Heading as="h1" size="xxl" mb="16px">
            {TranslateString(738, 'SUICIDE SQUAD Pool')}
          </Heading>
          <ul>
            <li>{TranslateString(580, `Stake ${TokenName} to earn new tokens.`)}</li>
            <li>{TranslateString(486, 'You can unstake at any time.')}</li>
            <li>{TranslateString(406, 'Rewards are calculated per block.')}</li>
          </ul>
        </div>
        <img src="/images/suicide-squad.png" alt="SUICIDE SQUAD icon" width={410} height={191} />
      </Hero>
